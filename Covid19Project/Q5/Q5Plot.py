...
def main(argv):
    ...
    #
    if len(argv) != 3:
      print("Usage:", "Q5/Q5Plot.py Q5/<data file> Q5/<graphics file>")
      sys.exit(-1)
    ...
    # This creates a barplot using seaborn
    
    g1 = sns.barplot(x = "Student and Staff", y = "Percentage of cases", data = csv_df)

    g1.set(title = graphtitle)

    # Now we can save the matplotlib figure that seaborn has drawn for us to a file
